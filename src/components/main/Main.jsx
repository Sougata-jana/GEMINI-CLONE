...
function Main() {
    const {onSent,isLoading,showResult,recentPrompt,resultData,input,setInput}= useContext(Context)
  return (
        <div className="main">
            <div className="nav">
                <p>Gemini</p>
            ...
            <>
                ...
                <p className="bottom-info">
                    Gemini might sometimes provide incorrect information, including details about people, so please verify its responses. Your privacy and Gemini Apps.
                </p>
                </div>
            </div>
        </div>
